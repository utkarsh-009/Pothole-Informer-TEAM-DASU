...
class _InformPageState extends State<InformPage> {
  ...
  LatLng potholeLocation = const LatLng(19.031, 73.014);
  XFile? _image;
  String imageURL =
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("Inform About Pothole"),
      ),
      body: Container(
...
//Defining the content inside each step
  List<Step> _mySteps() {
    List<Step> _steps = [
      ...
      Step(
        title: const Text('Address of Pothole', style: TextStyle(fontSize: 20)),
        content: Form(
      ...
      Step(
        title: const Text('Description of Pothole',
            style: TextStyle(fontSize: 20)),
